...
class PurchaseAdmin(admin.ModelAdmin):
    list_display = ['customer_id', 'vendor_id', 'items_purchased', 'item_cost', 'transporter', 'distance', 'transportation_cost', 'transaction_completed', 'total_price', 'created_at', 'updated_at']
